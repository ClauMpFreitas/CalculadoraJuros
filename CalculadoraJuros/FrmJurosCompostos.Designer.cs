...
namespace CalculadoraJuros
{
	partial class FrmJurosCompostos
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnCalcular.Location = new System.Drawing.Point(259, 282);
			...
			// opttaxa
			// 
			this.opttaxa.Location = new System.Drawing.Point(416, 39);
			...
			// optperiodo
			// 
			this.optperiodo.Location = new System.Drawing.Point(269, 39);
			...
			// optjuros
			// 
			this.optjuros.Location = new System.Drawing.Point(154, 39);
			...
			this.txtmontante.Location = new System.Drawing.Point(429, 232);
			...
			this.label5.Text = "Montante (Só estará disponiível na opção Taxa de juros)";
			// 
			// label6
			// 
	...
	"ltado do cálculo, é porque ela não será necessária para a fórmula do cálculo.";
			...
			this.Name = "FrmJurosCompostos";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Calculadora de Juros";
			this.Shown += new System.EventHandler(this.FrmJurosCompostosShown);
